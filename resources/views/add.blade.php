...
@section('content')
    ...
    <div class="row 5">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="masukkan alamat" name="alamat"rows="3"></textarea>
        </div>
        <div class="mb-3">
            <div class="form-check">
              ...
              <div class="form-check">
                <input value="Perempuan" class="form-check-input" type="radio" name="jenis_kelamin" id="flexRadioDefault2" checked>
                <label class="form-check-label" for="jenis_kelamin">
                  perempuan
                </label>
              </div>
